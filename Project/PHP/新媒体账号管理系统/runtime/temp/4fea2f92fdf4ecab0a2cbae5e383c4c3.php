<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\wwwroot\XinmeitiAcc\public_html\public/../application/index\view\manager\editdy.html";i:1542789961;s:81:"D:\wwwroot\XinmeitiAcc\public_html\application\index\view\common\admin-slide.html";i:1542789960;}*/ ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="utf-8" />
    <title>编辑抖音账号信息</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta content="后台管理系统-管理员-编辑抖音账号信息" />
...
<script>
    ...
    <div class="wrapper">
        <div class="col-lg-6  card-center">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">编辑抖音账号信息</h4>
                    <hr>
                    <form class="form-horizontal" method="POST">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <select class="form-control self-select" data-toggle="select2" name="pid" readonly="readonly">
                                    ...
                                    <option value="<?php echo $a['id']; ?>" readonly="readonly" selected><?php echo $a['phonesn']; ?></option>
                                    <?php else: ?>
                                    <option value="<?php echo $a['id']; ?>" readonly="readonly"><?php echo $a['phonesn']; ?></option>
                                    <?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音账号</label>
                            <div class="col-9">
                                <input type="text" name="dyaccount" class="form-control" id="inputEmail3" value="<?php echo $sel['dyaccount']; ?>" placeholder="抖音账号">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音密码</label>
                            <div class="col-9">
                                <input type="text" name="dypass" class="form-control" id="inputEmail3" value="<?php echo $sel['dypass']; ?>" placeholder="抖音密码">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音名称</label>
                            <div class="col-9">
                                <input type="text" name="dyname" class="form-control" id="inputEmail3" value="<?php echo $sel['dyname']; ?>" placeholder="抖音名称">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音粉丝量</label>
                            <div class="col-3">
                                <input type="text" name="dyfans" class="form-control" id="inputEmail3" value="<?php echo $sel['dyfans']; ?>" placeholder="粉丝量">
                            </div>
