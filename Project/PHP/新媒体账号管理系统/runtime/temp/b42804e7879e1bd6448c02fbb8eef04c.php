<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\wwwroot\XinmeitiAcc\public_html\public/../application/index\view\manager\adddy.html";i:1542789961;s:81:"D:\wwwroot\XinmeitiAcc\public_html\application\index\view\common\admin-slide.html";i:1542789960;}*/ ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="utf-8" />
    <title>添加抖音账号信息</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta content="后台管理系统-管理员-添加抖音账号信息" />
        ...
        <div class="col-lg-6 card-center">
            <div class="card ">
                <div class="card-body">
                    ...
                    <h4 class="mb-3 header-title">添加抖音账号信息</h4>
                    <hr>
                    <form class="form-horizontal" method="POST">
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音账号 </label>
                            <div class="col-9">
                                <input type="text" name="dyaccount" class="form-control" id="inputEmail3" placeholder="抖音账号">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音密码</label>
                            <div class="col-9">
                                <input type="text" name="dypass" class="form-control" id="inputEmail3" placeholder="抖音密码">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音名称</label>
                            <div class="col-9">
                                <input type="text" name="dyname" class="form-control" id="inputEmail3" placeholder="抖音名称">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">抖音粉丝量</label>
                            <div class="col-3">
                                <input type="text" name="dyfans" class="form-control" id="inputEmail3" placeholder="抖音粉丝量">
                            </div>
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <select class="form-control self-select" data-toggle="select2" name="pid">
                                    <?php if(is_array($sel) || $sel instanceof \think\Collection || $sel instanceof \think\Paginator): $i = 0; $__LIST__ = $sel;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?>
