<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\wwwroot\XinmeitiAcc\public_html\public/../application/index\view\index\index.html";i:1545903778;s:80:"D:\wwwroot\XinmeitiAcc\public_html\application\index\view\common\user-slide.html";i:1542789960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <!-- <link href="__PUBLIC__css/fixed-table.css" rel="stylesheet" type="text/css" /> -->
    ...
    <div class="table-wrapper">
            ...
            <table class="table table-title table-fixed-title" cellpadding="0" cellspacing="0" style="table-layout:fixed">
                <thead>
                    <tr class="table-head">
                        ...
                        <td colspan="3" class="text text-four borderRight" style="width:450px;">微信</td>
        ...
        <div class="table-row-wrap">
            ...
            <div class="table-fixed-left-body">
                <table class="table table-title table-fixed-left" cellpadding="0" cellspacing="0" style="table-layout:fixed;width:360px;">
                    <tbody>
                        ...
                        <tr class="table-bg text-text">
                            <td class="w-120 row1"><?php echo $i; ?></td>
                            <td class="table-self-fixed-head w-120 row1">
                                <div class="table-title w-120"><?php echo $a['phonesn']; ?></div>
                            </td>
                            <td class="borderRight w-120 row1">
                                <div class="table-title  w-120"><?php echo $a['phonebrand']; ?></div>
                            </td>
                            <td class=" w-150">
                                <div class="table-title "><?php echo substr_replace($a['phonesim1'],'****',3,4); ?></div>
                            </td>
                            <td class="borderRight  w-150">
                                <div class="table-title"><?php echo substr_replace($a['phonesim2'],'****',3,4); ?></div>
                            </td>
                            <td class=" w-150">
                            ...
                            <td class="w-150">
                                <div class="table-title "><?php echo substr_replace($a['wxaccount'],'****',3,4); ?></div>
                            </td>
                            <td class="w-150">
                                <div class="table-title "><?php echo $a['wxname']; ?></div>
                            </td>
                            <td class="w-150  text-fans" onclick="dyfans(<?php echo $a['id']; ?>,'wx')">
            ...
            <table class="table table-title table-fixed-content" cellpadding="0" cellspacing="0" style="table-layout:fixed">
                ...
                <tbody>
                    ...
                    <tr class="table-bg text-text">
                        ...
                        <td class="w-150 borderRight text-fans" onclick="dyfans(<?php echo $a['id']; ?>,'wx')">
                            <div class="table-title "><?php echo $a['wxfans']; ?></div>
                        </td>
                        <td class="w-150">
                            <div class="table-title "><?php echo $a['phonecharge']; ?></div>
