<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\wwwroot\XinmeitiAcc\public_html\public/../application/index\view\manager\wxlist.html";i:1542789961;s:81:"D:\wwwroot\XinmeitiAcc\public_html\application\index\view\common\admin-slide.html";i:1542789960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta content="新媒体账号管理系统-管理员-微信数据列表" />
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">微信数据列表</h4>
                        <a href="<?php echo url('Manager/addwx'); ?>" class="btn btn-success btn-sm float-right">添加微信数据</a>
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr class="table-bg text-text">
                                    ...
                                    <th><?php echo $a['wxaccount']; ?></th>
                                    <th><?php echo $a['wxpass']; ?></th>
                                    <th><?php echo $a['wxname']; ?></th>
                                    <th><?php echo $a['wxfans']; ?></th>
                                    <th><?php echo $a['wxtime']; ?></th>
                                    <td><a href="editwx?id=<?php echo $a['id']; ?>">编辑</a>|<a href="delwx?id=<?php echo $a['id']; ?>" onclick="return confirm('确定要删除吗?')">删除</a>|<a
                                            href="editwxfans?id=<?php echo $a['id']; ?>" style="color:#c72128;">修改粉丝量</a></td>
                                </tr>
                                <?php break; case "1": ?>
                                <tr class="">
                                    <th><?php echo $a['id']; ?></th>
