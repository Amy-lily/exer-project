<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"D:\wwwroot\XinmeitiAcc\public_html\public/../application/index\view\manager\editphone.html";i:1542789961;s:81:"D:\wwwroot\XinmeitiAcc\public_html\application\index\view\common\admin-slide.html";i:1542789960;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta content="后台管理系统-管理员-编辑手机信息" />
...
<script>
    ...
    <div class="wrapper">
            <div class="col-lg-6  card-center">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title">编辑手机信息</h4>
                            <hr>
                            <form class="form-horizontal" method="POST">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-9">
                                        <input type="text" name="phonesn" class="form-control" id="inputEmail3" value="<?php echo $sel['phonesn']; ?>" placeholder="手机编号">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label for="inputEmail3" class="col-3 col-form-label">手机品牌</label>
                                    <div class="col-9">
                                        <input type="text" name="phonebrand" class="form-control" id="inputEmail3" value="<?php echo $sel['phonebrand']; ?>" placeholder="手机品牌">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label for="inputEmail3" class="col-3 col-form-label">SIM卡1</label>
                                    <div class="col-9">
                                        <input type="text" name="phonesim1" class="form-control" id="inputEmail3" value="<?php echo $sel['phonesim1']; ?>" placeholder="SIM卡1">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label for="inputEmail3" class="col-3 col-form-label">SIM卡2</label>
                                    <div class="col-9">
                                        <input type="text" name="phonesim2" class="form-control" id="inputEmail3" value="<?php echo $sel['phonesim2']; ?>" placeholder="SIM卡2">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label for="inputEmail3" class="col-3 col-form-label">开户名（卡1）</label>
                                    <div class="col-9">
                                        <input type="text" name="phonecreate1" class="form-control" id="inputEmail3" value="<?php echo $sel['phonecreate1']; ?>" placeholder="开户名（卡1）">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label for="inputEmail3" class="col-3 col-form-label">开户名（卡2）</label>
                                    <div class="col-9">
                                        <input type="text" name="phonecreate2" class="form-control" id="inputEmail3" value="<?php echo $sel['phonecreate2']; ?>" placeholder="开户名（卡2）">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                    <label for="inputEmail3" class="col-3 col-form-label">负责人</label>
                                    <div class="col-9">
                                        <input type="text" name="phonecharge" class="form-control" id="inputEmail3" value="<?php echo $sel['phonecharge']; ?>" placeholder="负责人">
                                    </div>
                                </div>
