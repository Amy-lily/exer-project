<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\wwwroot\XinmeitiAcc\public_html\public/../application/index\view\manager\addks.html";i:1542789961;s:81:"D:\wwwroot\XinmeitiAcc\public_html\application\index\view\common\admin-slide.html";i:1542789960;}*/ ?>
<!DOCTYPE html>
<html lang="en">

<head>
    <meta charset="utf-8" />
    <title>添加快手账号信息</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta content="后台管理系统-管理员-添加快手账号信息" />
        ...
        <div class="col-lg-6 card-center">
            <div class="card ">
                <div class="card-body">
                    ...
                    <h4 class="mb-3 header-title">添加快手账号信息</h4>
                    <hr>
                    <form class="form-horizontal" method="POST">
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">快手账号 </label>
                            <div class="col-9">
                                <input type="text" name="ksaccount" class="form-control" id="inputEmail3" placeholder="快手账号">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">快手密码</label>
                            <div class="col-9">
                                <input type="text" name="kspass" class="form-control" id="inputEmail3" placeholder="快手密码">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">快手名称</label>
                            <div class="col-9">
                                <input type="text" name="ksname" class="form-control" id="inputEmail3" placeholder="快手名称">
                            </div>
                        </div>
                        <div class="form-group row mb-3">
                            <label for="inputEmail3" class="col-3 col-form-label">快手粉丝量</label>
                            <div class="col-3">
                                <input type="text" name="ksfans" class="form-control" id="inputEmail3" placeholder="快手粉丝量">
                            </div>
