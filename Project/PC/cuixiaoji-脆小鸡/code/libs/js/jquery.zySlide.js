...
(function($) {
    ...
    function Slide(ele, options) {
        ...
        this.states = [
            { '&zIndex': 1, width: 300, height: 180, top: 60, left: 2, $opacity: 0.3 },
            { '&zIndex': 2, width: 300, height: 180, top: 60, left: 2, $opacity: 0.3 },
            { '&zIndex': 3, width: 400, height: 240, top: 34, left: 104, $opacity: 0.3 },
            { '&zIndex': 4, width: 500, height: 300, top: 0, left: 204, $opacity: 1 },
            { '&zIndex': 3, width: 400, height: 240, top: 34, left: 403, $opacity: 0.3 },
            { '&zIndex': 2, width: 300, height: 180, top: 60, left: 603, $opacity: 0.3 },
            { '&zIndex': 1, width: 300, height: 180, top: 60, left: 603, $opacity: 0.3 }
        ]
